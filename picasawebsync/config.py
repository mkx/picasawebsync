...
# Upload video code came form http://nathanvangheem.com/news/
...
def InsertVideo(self, album_or_uri, video, filename_or_handle,
    ...
    if isinstance(filename_or_handle, (str, unicode)) and \
        ...
        raise GooglePhotosException(
            {
                'status': GPHOTOS_INVALID_ARGUMENT,
                'body': '`filename_or_handle` must be a path name or a '
                'file-like object',
